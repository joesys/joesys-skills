...
> Where do you store your screenshots? (full path — saved to `.codex/skill-context/ss.md`)
>
...
This skill runs its own first-run calibration — read and update `.codex/skill-context/human-review-guide.md` if it already exists rather than re-asking.
