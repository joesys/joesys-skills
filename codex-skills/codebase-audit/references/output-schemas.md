...
├── project-context.md              # Legacy — migrated to .codex/skill-context/
└── YYYYMMDD/
...
- **Config source:** {.codex/audit.yaml | auto-detected}
...
`.codex/skill-context/preferences.md`. Audit-specific context (known
trade-offs, deployment cadence, audit history) is stored in
`.codex/skill-context/codebase-audit.md`.
