...
Tools specific to TypeScript/JavaScript projects. Read this alongside `./tooling/general.md`. All tools follow the safety rules, detection flow, and execution protocol in `./tooling-registry.md`.
