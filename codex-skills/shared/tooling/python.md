...
Tools for Python projects. Read this file alongside `./tooling/general.md`. All tools follow the safety rules, detection flow, and execution protocol defined in `./tooling-registry.md`.
...
| **Category** | Security Scanner |
| **Tier** | 4 |
| **Detection** | `.semgrep.yml`, `.semgrep/` directory, `semgrep` in CI config files (see `./tooling/general.md`) |
