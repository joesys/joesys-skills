...
Tools and patterns for C and C++ projects. Read this file alongside `./tooling/general.md`. All tools listed here follow the safety rules, detection flow, and execution protocol defined in `./tooling-registry.md`.
