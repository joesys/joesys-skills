...
Tools and patterns that apply across multiple languages. Read this file alongside the relevant language-specific profile (`./tooling/<language>.md`). All tools listed here follow the safety rules, detection flow, and execution protocol defined in `./tooling-registry.md`.
