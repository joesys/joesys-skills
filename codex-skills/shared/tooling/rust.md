...
Tools for Rust projects. Read this file alongside `./tooling/general.md`. All tools follow the safety rules, detection flow, and execution protocol defined in `./tooling-registry.md`.
