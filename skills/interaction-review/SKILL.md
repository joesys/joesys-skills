...
**MUST dispatch all 5 subagents simultaneously** — all 5 in a single response using the Agent tool. Each uses `model: "opus"`. Read `references/agent-prompts.md` for full prompt templates and guiding principles.
...
3. Session Summary
4. Per-Lens Deep Dive (×5, or fewer if agents failed)
